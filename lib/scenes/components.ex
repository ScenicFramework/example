defmodule Example.Scene.Components do
  @moduledoc """
  Sample scene.
  """
  ...
  @buttons [
    ...
    button_spec("Light", id: :btn_light, t: {305, 0}, theme: :light),
    button_spec("Warning", id: :btn_warning, t: {391, 0}, theme: :warning),
    button_spec("Dark", id: :btn_dark, t: {0, 44}, theme: :dark),
    button_spec("Text", id: :btn_text, t: {88, 44}, theme: :text),
    button_spec("Danger", id: :btn_danger, theme: :danger, t: {175, 44}),
  ...
  @graph Graph.build(font: :roboto, font_size: 24)
         ...
         # Nav is added last so that it draws on top
